...
func TestAccExampleDataAccessProfile(t *testing.T) {
	...
	accessProfileName = accessProfileName + "-datasource"
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				Config: configAccessProfileData(accessProfileName, identityId, sourceId, entitlementId),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("data.identitynow_access_profile.access_profile", "name", accessProfileName),
				),
			},
		},
	})
...
func configAccessProfileData(name, userId, sourceId, entitlementId string) string {
	return fmt.Sprintf(`
