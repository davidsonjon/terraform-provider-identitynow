...
- **Resources** (19): `access_model_metadata_attribute_v1`, `access_profile_v1`,
  ...
  `source_provisioning_policy_v1`, `source_schema_v1`, `source_v1`,
  `transform_v1`.
- **Data sources** (28): singular + plural pairs for most of the above
...
modeled here but are reasonable candidates for future pilots, roughly in
priority order:

1. **Workflows** (`GET/POST /workflows`) - one of the most frequently
