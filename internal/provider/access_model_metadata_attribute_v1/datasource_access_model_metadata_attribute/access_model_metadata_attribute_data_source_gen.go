...
package datasource_access_model_metadata_attribute
...
func AccessModelMetadataAttributeDataSourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"key": schema.StringAttribute{
				...
				MarkdownDescription: "Technical name of the Attribute.",
			},
