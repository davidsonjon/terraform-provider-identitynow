...
from SailPoint's per-service `/transforms/v1` OpenAPI spec, and
Create/Read/Update/Delete are hand-written against `golang-sdk/v3`'s
`transforms.TransformsAPIService` client. The following was learned
