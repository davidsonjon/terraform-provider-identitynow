...
`GET /sources/v1/{sourceId}/schemas` (`golang-sdk/v3`'s
`sources.SourcesAPIService.GetSourceSchemasV1`), mirroring
...
is complete, alongside the parent resource - see that section for details.
